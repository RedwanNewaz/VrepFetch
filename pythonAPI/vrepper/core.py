...
from .lib.vrepConst import sim_handle_all, simx_headeroffset_server_state, \
...
from .utils import check_ret, blocking, oneshot, instance, deprecated
from .vrep_object import vrepobject
import time
VREP_DIR = '/Users/redwannewaz/Downloads/V-REP_PRO_EDU_V3_5_0_Mac/vrep.app/Contents/MacOS/'
...
class vrepper(object):
    ...
    def __init__(self, port_num=None,  headless=False, suppress_output=True, restart = True):
        if port_num is None:
    ...
    def start(self):
        ...
        while True:
            ...
            self.simxFinish() # just in case, close all opened connections
    ...
    def stop_simulation(self):
        ...
        check_ret(self.simxStopSimulation(blocking), ignore_one=False)
        self.sim_running = False
